...
public class IRISCamPanel extends JPanel
{
	...
	protected BufferedImage process()
	{
		...
		// Core.inRange(m, new Scalar(38, 50, 50), new Scalar(255, 100, 100),
		// m);
		...
		// CvType.typeToString(thresholdedImg.type()));
		...
		// Core.inRange(mat, new Scalar(38, 50, 50), new Scalar(255, 100, 100),
		// temp);
