...
public class IRISCamManager implements Runnable
{
	...
	public void init(int fps, int port, String usbConnection,
	...
	public void run()
	{
		try
		{
			for (;;)
			{
				...
				{
					System.out
							.println("Failed to connect to wired connetion, retrying with wireless...");
					System.out.println("Trying to connect to "
							+ wirelessConnectionIP + ":" + port + "...");
				...
				while (!Thread.interrupted())
				{
					...
					assert ((data.length >= 4) && (data[0] == 255)
							&& (data[1] == 216)
